# file_name: glute_bridges_detector.py

import math
from app.engines.exercise.base_exercise import BaseExercise


class GluteBridgesDetector(BaseExercise):
    UP_THRESHOLD = 160  # Hips lifted / straight line from shoulder to knee
    DOWN_THRESHOLD = 120  # Hips resting near the ground
    MIN_VISIBILITY = 0.7
