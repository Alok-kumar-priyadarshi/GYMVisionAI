# file_name: sumo_squats_detector.py

import math
from app.engines.exercise.base_exercise import BaseExercise


class SumoSquatsDetector(BaseExercise):
    UP_THRESHOLD = 160
    DOWN_THRESHOLD = 90
    MIN_VISIBILITY = 0.7
    WIDE_STANCE_TOLERANCE = 0.15
    ...
    def process(self, landmarks) -> dict:
        ...
        # Form check: ensure wider stance for sumo squats
        ...
        if ankle_distance > shoulder_distance * 1.3:
            form_status = "WIDE STANCE GOOD"
        else:
            form_status = "WIDEN YOUR STANCE"
