# file_name: high_knees_detector.py
...
class HighKneesDetector(BaseExercise):
    # Thresholds for tracking high knees mechanics
    UP_THRESHOLD = 90        # Thigh parallel to ground angle threshold
    DOWN_THRESHOLD = 150     # Standing straight leg angle threshold
    MIN_VISIBILITY = 0.7
    ...
    def process(self, landmarks) -> dict:
        ...
        if key_landmarks_visible:
            # Determine active leg based on which knee is raised higher (smaller angle)
            ...
            # Rep counting logic for alternating high knees
